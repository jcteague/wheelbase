...
```json
{
  "ok": false,
  "errors": [
    { "field": "__phase__",               "code": "invalid_phase",              "message": "No open covered call on this position" },
    { "field": "closePricePerContract",   "code": "must_be_positive",           "message": "Close price must be greater than zero" },
    { "field": "fillDate",                "code": "close_date_before_open",     "message": "Fill date cannot be before the CC open date" },
    { "field": "fillDate",                "code": "close_date_after_expiration","message": "Fill date cannot be after the CC expiration date — use Record Expiry instead" },
