...
- [x] **[Green]** Implement — `src/main/services/active-leg-sql.ts`, `src/main/services/list-positions.ts`, `src/main/services/get-position.ts` _(depends on: Area 1 Red ✓)_
...
- [x] **[Refactor]** `/refactor` — `src/main/services/active-leg-sql.ts`, `src/main/services/list-positions.ts`, `src/main/services/get-position.ts` _(depends on: Area 1 Green ✓)_
...
- [x] **[Green]** Implement — `src/renderer/src/lib/rolls.ts`, `src/renderer/src/components/RollCspForm.tsx`, `src/renderer/src/components/RollCspSuccess.tsx` _(depends on: Area 2 Red ✓)_
...
- [x] **[Refactor]** `/refactor` — `src/renderer/src/lib/rolls.ts`, `src/renderer/src/components/RollCspForm.tsx`, `src/renderer/src/components/RollCspSuccess.tsx` _(depends on: Area 2 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [x] **[Red]** Verify existing tests specify behavior — `src/renderer/src/components/RollCspSheet.test.tsx` _(depends on: Area 2 Green ✓)_
...
- [x] **[Green]** Implement — `src/renderer/src/components/RollCspSheet.tsx`, `src/renderer/src/components/RollCspForm.tsx` _(depends on: Area 3 Red ✓)_
  - In `RollCspSheet.tsx`:
...
- [x] **[Refactor]** `/refactor` — `src/renderer/src/components/RollCspSheet.tsx`, `src/renderer/src/components/RollCspForm.tsx` _(depends on: Area 3 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
