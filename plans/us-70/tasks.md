...
- [ ] **[Red]** Write failing tests — `src/main/integrations/finnhub-earnings.test.ts`
...
- [ ] **[Green]** Implement — `src/main/integrations/finnhub-earnings.ts` _(depends on: Area 1 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` — `src/main/integrations/finnhub-earnings.ts` _(depends on: Area 1 Green ✓)_
...
- [ ] **[Red]** Write failing tests — `src/main/services/earnings-dates.test.ts` _(depends on: Area 1 Green ✓)_
...
- [ ] **[Green]** Implement — `src/main/services/earnings-dates.ts` _(depends on: Area 2 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` — `src/main/services/earnings-dates.ts` _(depends on: Area 2 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] **[Red]** Write failing tests — `src/main/core/screener.test.ts` _(depends on: Area 1 Green ✓)_
...
- [ ] **[Green]** Implement — `src/main/core/screener.ts` _(depends on: Area 4 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` — `src/main/core/screener.ts` _(depends on: Area 4 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] **[Red]** Write failing tests — `src/main/services/evaluate-alerts.test.ts`, `evaluate-alerts.e2e.test.ts` _(depends on: Area 2 Green ✓)_
...
- [ ] **[Green]** Implement — `src/main/services/evaluate-alerts.ts` _(depends on: Area 3 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` — `src/main/services/evaluate-alerts.ts` _(depends on: Area 3 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] **[Red]** Write failing tests — `src/main/services/screener.test.ts` _(depends on: Area 2 Green ✓, Area 4 Green ✓)_
...
- [ ] **[Green]** Implement — `src/main/services/screener.ts` _(depends on: Area 5 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` — `src/main/services/screener.ts` _(depends on: Area 5 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] **[Red]** Write failing tests — `src/main/ipc/screener.test.ts`, `src/renderer/src/api/screener.test.ts` _(depends on: Area 4 Green ✓)_
...
- [ ] **[Green]** Implement — `src/preload/index.d.ts`, `src/renderer/src/api/screener.ts` _(depends on: Area 6 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` _(depends on: Area 6 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] **[Red]** Write failing tests — `src/renderer/src/components/EarningsBadge.test.tsx`, `ScreenerResultsTable.test.tsx` _(depends on: Area 6 Green ✓)_
...
- [ ] **[Green]** Implement — `src/renderer/src/components/EarningsBadge.tsx`, `ScreenerResultsTable.tsx` _(depends on: Area 7 Red ✓)_
...
- [ ] **[Refactor]** `/refactor` — `src/renderer/src/components/EarningsBadge.tsx` _(depends on: Area 7 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] **[Red]** Write failing e2e tests — `e2e/screener-earnings.spec.ts` _(depends on: all Green tasks ✓)_
...
- [ ] **[Refactor]** `/refactor` e2e tests _(depends on: Area 8 Green ✓)_
  - **Invoke the `/refactor` skill** — do not skip or treat as a visual review
...
- [ ] E2E tests cover all ten ACs
- [ ] No occurrence of `earningsFlagged` remains anywhere in `src/`
- [ ] `src/main/core/screener.ts` still imports nothing from `integrations/`, `db/`, or `logger`
- [ ] US-56 alert tests pass with no assertions weakened
- [ ] Live smoke check run once (`quickstart.md`) — confirm Finnhub free tier returns events ~50 days out
- [ ] `pnpm test && pnpm lint && pnpm typecheck && pnpm format` — all clean
