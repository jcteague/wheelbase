...
- [x] **[Green]** Implement — `src/main/schemas.ts` + `src/main/services/get-position.ts` *(depends on: Area 1 Red ✓)*
...
- [x] **[Refactor]** Clean up *(depends on: Area 1 Green ✓)*
...
- [x] **[Green]** Implement — `src/renderer/src/api/positions.ts` *(depends on: Area 2 Red ✓)*
...
- [x] **[Refactor]** Clean up *(depends on: Area 2 Green ✓)*
  - Run `pnpm test && pnpm lint && pnpm typecheck`
...
- [x] **[Green]** Implement — `src/renderer/src/lib/deriveRunningBasis.ts` *(depends on: Area 3 Red ✓)*
...
- [x] **[Refactor]** Clean up *(depends on: Area 3 Green ✓)*
...
- [x] **[Green]** Implement — `src/renderer/src/lib/phase.ts` *(depends on: Area 4 Red ✓)*
...
- [x] **[Refactor]** Clean up *(depends on: Area 4 Green ✓)*
...
- [x] **[Red]** Write failing tests — `src/renderer/src/components/LegHistoryTable.test.tsx` *(depends on: Area 4 Green ✓)*
...
- [x] **[Green]** Implement — `src/renderer/src/components/LegHistoryTable.tsx` *(depends on: Area 5 Red ✓)*
...
- [x] **[Refactor]** Clean up *(depends on: Area 5 Green ✓)*
...
- [x] **[Red]** Write failing tests — `src/renderer/src/pages/PositionDetailPage.test.tsx` *(depends on: Areas 1, 2, 3, 5 Green ✓)*
...
- [x] **[Green]** Implement — `src/renderer/src/pages/PositionDetailPage.tsx` *(depends on: Area 6 Red ✓)*
  ...
  - Run `pnpm test src/renderer/src/pages/PositionDetailPage.test.tsx` — all tests must pass
- [x] **[Refactor]** Clean up *(depends on: Area 6 Green ✓)*
...
- [x] **[Red]** Write failing e2e tests — `e2e/leg-chain-display.spec.ts` *(depends on: all Green tasks ✓)*
