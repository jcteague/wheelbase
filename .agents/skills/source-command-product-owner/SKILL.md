...
Use this skill when the user asks to run the migrated source command `product-owner`.
...
Treat any user-provided text as the feature brief, backlog request, or story-refinement input for this skill.
...
Invoke this skill as `$source-command-product-owner`.
