...
Use this skill when the user asks to run the migrated source command `.agents-skills-shadcn-rules-base-vs-radix`.
...
Invoke this skill as `$source-command--agents-skills-shadcn-rules-base-vs-radix`.
