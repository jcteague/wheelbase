...
Use this skill when the user asks to run the migrated source command `.agents-skills-shadcn-cli`.
...
Invoke this skill as `$source-command--agents-skills-shadcn-cli`.
