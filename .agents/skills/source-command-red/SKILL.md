...
Use this skill when the user asks to run the migrated source command `red`.
...
Treat any user-provided text, feature directory, story path, or plan path as the command input for the red-phase work.
...
Invoke this skill as `$source-command-red`.
