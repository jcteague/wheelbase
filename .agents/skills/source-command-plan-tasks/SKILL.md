...
Use this skill when the user asks to run the migrated source command `plan-tasks`.
...
Invoke this skill as `$source-command-plan-tasks`.

Treat any user-provided text as the plan file path, story path, or planning request to process.
