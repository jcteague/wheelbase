...
Use this skill when the user asks to run the migrated source command `options-expert`.
...
Treat any user-provided text as the trading-domain question, workflow, or requirement scenario to analyze.
...
Invoke this skill as `$source-command-options-expert`.
