...
Invoke this skill as `$source-command-implement-plan`.

Treat any user-provided text as the plan file path, feature directory, or implementation request to execute.
