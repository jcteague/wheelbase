...
Treat any user-provided text, feature directory, story path, or plan path as the command input for the refactor-phase work.
...
Invoke this skill as `$source-command-refactor`.
